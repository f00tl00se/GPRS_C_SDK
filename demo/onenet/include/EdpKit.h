...
#define EDP_MallocBuffer    OS_Malloc

#define EDP_FreeBuffer      OS_Free
//==========================================================
...
/*--------------------------------登录方式2组包--------------------------------*/
uint8 EDP_PacketConnect2(const int8 *devid, const int8 *auth_key, uint16 cTime, EDP_PACKET_STRUCTURE *edpPacket);
